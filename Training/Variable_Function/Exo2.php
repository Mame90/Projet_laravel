...
<body>
    ...
    $prenom = 'Mbaye';
    $nom = 'Diop';
    define('universite', ' universite Alioune Diop');
    ...
    switch ($xaliss) {
        case 1000:
            echo "Boy amo xaliss demal ngua tokk";
            break;
        case 2000:
            echo "Machallah boy amngua passou magual";
            break;
        case 3000:
            echo "Machallah boy amngua passou magual";
            break;
        default:
            echo "koy fontoo fils :)";
    }
