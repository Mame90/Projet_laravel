                ...
                <form class="form" role="form" method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="price" name="price" min="0" placeholder="0.00" value="<?php echo $price; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="5" value="<?= $description ?>"><?= $description ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control-file" id="media" name="media" value="<?php echo $picture; ?>">
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn btn-info btn-sm mb-4"><i class="bi bi-pencil"></i> Ajouter</button>
                    </div>
                </form>
